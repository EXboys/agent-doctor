...
pub use merge::{
    ...
    CODEX_PERSONAL_SLOT, CODEX_TEAM_SLOT, COMPANY_DEFAULT_MODEL, HERMES_PERSONAL_SLOT,
    HERMES_TEAM_SLOT, OPENCLAW_PERSONAL_SLOT, OPENCLAW_PROVIDER_ID, OPENCLAW_TEAM_SLOT,
};
pub use mode::{
