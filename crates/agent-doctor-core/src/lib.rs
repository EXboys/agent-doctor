...
pub use workspace::{
    active_env_path, bash_hook_file_path, browser_configured_runtimes, ensure_default_workspace,
    enter_workspace, fish_hook_file_path, hook_file_path, init_workspace, install_bash_hook,
    install_fish_hook, install_powershell_hook, install_zsh_hook, list_mcp_inventory,
    list_mcp_inventory_with_doc, load_workspaces, match_workspace_for_path,
    ...
    save_workspaces, use_workspace, use_workspace_with_options, workspace_capability_matrix,
    workspace_doctor, workspace_fix, workspace_hook_status, workspace_show, workspace_status,
    workspaces_path, write_direnv_envrc, CapabilityCell, CapabilityMatrix,
    ClaudeMcpMigrationReport, EnterWorkspaceReport, GatewayRestartReport, InitWorkspaceReport,
    McpInventoryItem, McpInventoryReport, ShellHookStatus, UseWorkspaceOptions, UseWorkspaceReport,
    WorkspaceCheck, WorkspaceCheckStatus, WorkspaceDoctorReport, WorkspaceEntry,
    WorkspaceFixAction, WorkspaceFixOptions, WorkspaceFixReport, WorkspaceShowReport,
    WorkspaceSnapshotStatus, WorkspaceStatusReport, WorkspacesDocument,
};
