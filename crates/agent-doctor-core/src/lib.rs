...
pub use workspace::{
    ...
    install_zsh_hook, installed_browser_mcp_runtime_ids, list_browser_mcp_targets,
    list_mcp_inventory, list_mcp_inventory_with_doc, load_workspaces, match_workspace_for_path,
    migrate_claude_global_mcp_to_project, powershell_hook_file_path, remove_workspace,
    render_direnv_envrc, render_shell_env, render_shell_env_for_name, resolve_agent_doctor_binary,
    save_workspaces, use_workspace, use_workspace_with_options, wire_browser_mcp_installed,
    workspace_capability_matrix, workspace_doctor, workspace_fix, workspace_hook_status,
    workspace_show, workspace_status, workspaces_path, write_direnv_envrc, BrowserMcpDiagnoseIssue,
    BrowserMcpDiagnoseWireReport, BrowserMcpTargetAction, BrowserMcpTargetStatus, CapabilityCell,
    CapabilityMatrix, ClaudeMcpMigrationReport, EnterWorkspaceReport, GatewayRestartReport,
    InitWorkspaceReport, McpInventoryItem, McpInventoryReport, ShellHookStatus,
