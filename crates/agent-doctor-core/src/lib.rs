...
pub use workspace::{
    active_env_path, bash_hook_file_path, browser_configured_runtimes, enter_workspace,
    fish_hook_file_path, hook_file_path, init_workspace, install_bash_hook, install_fish_hook,
    install_powershell_hook, install_zsh_hook, list_mcp_inventory, list_mcp_inventory_with_doc,
    load_workspaces, match_workspace_for_path, migrate_claude_global_mcp_to_project,
    powershell_hook_file_path, remove_workspace, render_direnv_envrc, render_shell_env,
    render_shell_env_for_name, resolve_agent_doctor_binary, save_workspaces, use_workspace,
    ...
    CapabilityCell, CapabilityMatrix, ClaudeMcpMigrationReport, EnterWorkspaceReport,
    GatewayRestartReport, InitWorkspaceReport, McpInventoryItem, McpInventoryReport,
    ShellHookStatus, UseWorkspaceOptions, UseWorkspaceReport, WorkspaceCheck, WorkspaceCheckStatus,
