...
pub use workspace::{
    ...
    ensure_default_workspace, enter_workspace, fish_hook_file_path, hook_file_path, init_workspace,
    install_bash_hook, install_fish_hook, install_powershell_hook, install_zsh_hook,
    installed_browser_mcp_runtime_ids, list_browser_mcp_targets, list_mcp_inventory,
