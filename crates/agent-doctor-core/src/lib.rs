...
pub use workspace::{
    ...
    ensure_default_workspace, enter_workspace, fish_hook_file_path, hook_file_path,
    ...
    InitWorkspaceReport, McpInventoryItem, McpInventoryReport, ShellHookStatus, UseWorkspaceOptions,
    UseWorkspaceReport, WorkspaceCheck, WorkspaceCheckStatus, WorkspaceDoctorReport,
    WorkspaceEntry, WorkspaceFixAction, WorkspaceFixOptions, WorkspaceFixReport,
    WorkspaceShowReport, WorkspaceSnapshotStatus, WorkspaceStatusReport, WorkspacesDocument,
};
