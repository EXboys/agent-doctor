...
pub use setup::{
    ...
    gateway_url_from_evotown_base, list_personal_providers, load_mode_status,
    ...
    ModeStatus, ModeSwitchReport, PersonalProviderListItem, PersonalProviderOptions,
    PersonalProviderSetupReport, PersonalProviderStatus, PersonalProviderVerifyReport,
    PersonalProvidersDocument, RuntimeSetupResult, SetupOptions, SetupReport,
    UpsertPersonalProviderOptions, MODE_PERSONAL, MODE_TEAM, MODE_UNSET, PROTOCOL_ANTHROPIC,
    PROTOCOL_OPENAI,
};
pub use workspace::{
