...
const messages = {
  en: {
    ...
    "personal.loading": "Checking personal provider…",
    "personal.notConfigured": "Point Codex / Claude / Hermes at any OpenAI-compatible API.",
    "personal.configured": "Personal provider configured",
    "personal.configuredUrl": "Configured:",
    "personal.url": "API Base URL",
    "personal.apiKey": "API Key",
    "personal.model": "Model",
    "personal.verify": "Verify",
    "personal.apply": "Save & apply",
    "personal.verifying": "Checking connectivity…",
    "personal.applying": "Saving and writing runtime configs…",
    "personal.verifyOk": "OK — {message}",
    "personal.verifyFailed": "Verify failed: {error}",
    "personal.applyOk": "Applied to {count} runtime(s). Doctor refreshed.",
    "personal.applyFailed": "Apply failed: {error}",
    "personal.meta": "model {model} · key {key}",
    "personal.footnote": "Writes Codex / Claude / Hermes. Does not connect Evotown.",
    "personal.missingFields": "URL, API key, and model are required.",
  },
  zh: {
    "app.eyebrow": "Agent Doctor",
    ...
    "personal.loading": "正在检查个人配置…",
    "personal.notConfigured": "把 Codex / Claude / Hermes 指向任意 OpenAI 兼容 API。",
    "personal.configured": "已配置个人 Provider",
    "personal.configuredUrl": "已配置：",
    "personal.url": "API Base URL",
    "personal.apiKey": "API Key",
    "personal.model": "模型",
    "personal.verify": "验证连通",
    "personal.apply": "保存并应用",
    "personal.verifying": "正在检查连通性…",
    "personal.applying": "正在保存并写入 runtime 配置…",
    "personal.verifyOk": "通过 — {message}",
    "personal.verifyFailed": "验证失败：{error}",
    "personal.applyOk": "已应用到 {count} 个 runtime，并刷新了诊断。",
    "personal.applyFailed": "应用失败：{error}",
    "personal.meta": "模型 {model} · key {key}",
    "personal.footnote": "写入 Codex / Claude / Hermes。不连接 Evotown。",
    "personal.missingFields": "请填写 URL、API Key 和模型。",
  },
} as const;
